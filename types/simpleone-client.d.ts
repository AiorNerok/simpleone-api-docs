...
declare class SimpleRecord {
    ...
    /**
     * Добавить условие выборки с оператором
     * @param field - Поле
     * @param operator - Оператор (=, !=, >, <, like, startswith, endswith, IN, NOT IN, ISEMPTY, ISNOTEMPTY)
     * @param value - Значение
     * @example
     * record.addQuery('subject', 'like', 'email');
     * record.addQuery('priority', '>=', '3');
     */
     ...
     * @param callback - Функция обратного вызова, получает текущий объект SimpleRecord
     */
    get(recordId: string, callback: (this: SimpleRecord) => void): void;
 ...
 * Также доступен в клиентском API для логирования
 */
