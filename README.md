...
* ✅ **Сниппеты кода** для всех классов API (80+ сниппетов)
...
### Серверное API (14 классов)

| Класс | Назначение |
|-------|------------|
| **SimpleRecord** | Работа с записями БД |
| **SimpleAttachment** | Вложения (файлы) |
...
| **SimpleMail** | Почтовый сервер |
| **SimpleCache** | Управление кэшем |
